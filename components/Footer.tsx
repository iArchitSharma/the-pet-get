...
function Footer() {
  return (
    <footer className="bg-background-1 mb-0 pb-0">
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
      <Image src='/logo.svg' alt='ThePetGet logo' width={250} height={100} unoptimized={true} />
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm font-medium">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Dog Training </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Grooming </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Veterinary </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Pet Relocation </a>
            </li>

            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Pet Insurance </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm font-medium">
            ...
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> News Center </a>
            </li>
          </ul>
        </div>
    ...
    <p className="text-xs text-gray-500">&copy; 2025. ThePetGet. All rights reserved.</p>
  </div>
</footer>
  )
}
